   ...
   <table id="example" class="display nowrap">
    ...
    <tr>
                   <?php
                      ...
                      $sum = mysqli_query($con,"SELECT SUM(amount) FROM formtwofees WHERE id='43434455'");
...
$('table').DataTable();
                  ...
                  <!-- /.tab-pane -->
                    ...
                    <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.formtwofees.store')}}">
                ...
                <!-- /.card-body -->
                    ...
                    <div class="card-footer">
                    <button type="submit" class="btn btn-infor">Submit</button>
                    </div>
                    </form>
                   </div>
                  <!-- /.tab-pane -->
                  <div class="tab-pane" id="parent">
                    ...
                    @foreach($details as $c)
                    <input type="text" class="form-control" value="{{ $c->phone}}" name="receiptno" id="exampleInputPassword1" placeholder="Receipt Number">
                     @endforeach
                    </div>
                    <div class="form-group">
                    <label for="exampleInputPassword1">Paid Amount</label>
