...
@section('content')
 ...
 <div class="content-header">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="info-box-content">
            ...
            <a href="{{ route('admin.formthreefees.index')}}"> <h6 style="color:white">Form Two Students
           </h6></a>
              </div>
              </span>
              ...
              <?php
                      ...
                      $sum = mysqli_query($con,"SELECT SUM(amount) FROM formthreefees");
          ...
          <!-- /.col -->
                  ...
                  <div class="col-md-2"><a href="{{ route('admin.formthreefees.create')}}" class="btn btn-primary">Make Payment</a></div></div>
                  <div class="container">
     ...
     <a href="{{ route('admin.formthreefees.edit', $c->id)}}" class="btn btn-primary fa fa-edit" ></a>
     <form id="delete_from_{{$c->id}}" method="POST" action="{{ route('admin.formthreefees.destroy', $c->id) }}">
      {{ csrf_field() }}
      {{ method_field('DELETE') }}
