   ...
   <table id="example" class="display nowrap">
    ...
    <tr>
                   <?php
                      ...
                      $sum = mysqli_query($con,"SELECT SUM(amount) FROM formthreefees WHERE id='43434455'");
...
$('table').DataTable();
                  ...
                  <!-- /.tab-pane -->
                    ...
                    <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.formthreefees.store')}}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="card-body">
                    <div class="form-group">
                    <label for="exampleInputEmail1">Student Admission Nob</label>
                ...
                <!-- /.card-body -->
                  ...
                  <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.formthreefees.store')}}">
                    ...
                    <div class="card-body">
                    <div class="form-group">
                    <label for="exampleInputEmail1">Student Admission Non</label>
                    <input type="text"  name="admissionno" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                    </div>
                    <div class="form-group">
                    <label for="exampleInputPassword1">Receipt Number</label>
                    <input type="text" class="form-control" name="receiptno" id="exampleInputPassword1" placeholder="Receipt Number">
