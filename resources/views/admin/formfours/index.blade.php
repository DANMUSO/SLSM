...
@section('content')
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0 text-dark">Form Four Students</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('home')}}">Dashboard</a></li>
              <li class="breadcrumb-item active">Form Four Students</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="info-box mb-3">
           ...
           <h6 style="color:white">Form Four Students
           </h6>
              </div>
              </span>
...
?> 
    ...
    <div class="col-md-2"><a href="{{ route('admin.formfours.create')}}" class="btn btn-primary">Add Students</a></div></div>
    <div class="container">
...
<table id="example" class="display nowrap">
    ...
    <tbody id="myTable">
      ...
      <a href="{{ route('admin.formfours.edit', $c->id)}}" class="btn btn-primary fa fa-edit" ></a>
      <form id="delete_from_{{$c->id}}" method="POST" action="{{ route('admin.formfours.destroy', $c->id) }}">
      {{ csrf_field() }}
      {{ method_field('DELETE') }}
