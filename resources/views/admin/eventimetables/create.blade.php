           ...
           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="typevent" required class="form-control"  placeholder="Type of Event">
                  </div>
                  <div class="col-md-4">
                    <p for="">Venue</p>
                    <input type="text" name="venue" required class="form-control"  placeholder="Venue">
                  </div>
                  <div class="col-md-4">
                    <p for="">Audiences</p>
                    <input type="text" name="audience" required class="form-control"  placeholder="Audiences">
                  </div>
                  <div class="col-md-4">
                    <p for="">Guest</p>
                    <input type="text" name="guest" required class="form-control"  placeholder="Guest">
                  </div>
                  <div class="col-md-4">
                    <p for="">Duration</p>
