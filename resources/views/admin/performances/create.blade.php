...
<div class="col-md-1"> </div>
   <div class="col-md-10">    <div class="">
       ...
       <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.performances.store')}}">
           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="row">
                  ...
                  <select name="id" class="select2_single form-control" style="width: 100%" tabindex="-1" >
                                        ...
                                        <?php
                                        $result= mysqli_query($con,"select * from formfours") or die (mysqli_error());
                ...
                <div class="col-md-4">
                    <p for="">Total Marks</p>
                    <input type="text" name="marks" require="required" class="form-control"  placeholder="Total Marks">
                    </div>
                <div class="col-md-4">
                
                    <p for="">Points</p>
                    <input type="text" name="point" require="required" class="form-control"  placeholder="Points">
                    </div>
