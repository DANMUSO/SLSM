           ...
           <hr>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="date" name="birth" required class="form-control"  placeholder="Date of Birth">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="accountholder" required class="form-control"  placeholder="Account Holder Name">
                    </div>
                    <div class="col-md-3">
                    <p for="">Account Number</p>
                    <input type="text" name="account" required class="form-control"  placeholder="Account Number">
                    </div>
                    <div class="col-md-3">
                    <p for="">Bank Name</p>
                    <input type="text" name="bank" required class="form-control"  placeholder="Bank Name">
                    </div>
                    <div class="col-md-3">
                    <p for="">Branch</p>
                    <input type="text" name="branch" required class="form-control"  placeholder="Branch">
                    </div>
                    </div>
                    <hr>
                    ...
                    <input type="text" name="id" required class="form-control" value="
                  <?php
                  ...
                  ">
                    ...
                    <input type="date" name="joindate" required class="form-control"  placeholder="Date of Joining">
                    </div>
                    </div>
                    <hr>
                    ...
                    <input type="text" name="basic" required class="form-control"  placeholder="Basic Salary">
                    </div>
                    <div class="col-md-3">
                    <p for="">Transport Allowance</p>
                    <input type="text" name="transport" required class="form-control"  placeholder="Transport Allowance">
                    </div>
                    <div class="col-md-3">
                    <p for="">Medical Allowance</p>
                    <input type="text" name="medical" required class="form-control"  placeholder="Medical Allowance">
                    </div>
                <div class="col-md-3">
                    <p for="">House Allowance</p>
                    <input type="text" name="house" required class="form-control"  placeholder="House Allowance">
                    </div>
                    <div class="col-md-4">
                    <p for="">NSSF NO</p>
                    <input type="text" name="nssf" required class="form-control"  placeholder="NSSF Amount">
                    </div>
                    <div class="col-md-4">
                    <p for="">NHIF NO</p>
                    <input type="text" name="nhif" required class="form-control"  placeholder="NHIF Amount">
                    </div>
                    <div class="col-md-4">
                    <p for="">County</p>
