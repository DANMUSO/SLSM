      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="info-box-content">
            ...
            <a href="{{ route('admin.formfourfees.index')}}"> <h6 style="color:white">Form Four Students
           </h6></a>
              </div>
              </span>
              ...
              <th>Total Fees 250,000 KES</td><th>     <a href="">Paid Fees  
                     <?php
                      ...
                      $sum = mysqli_query($con,"SELECT SUM(amount) FROM formfourfees");
        ...
        <!-- /.row -->
                  ...
                  <div class="col-md-2"><a href="{{ route('admin.formfourfees.create')}}" class="btn btn-primary">Make Payment</a></div></div>
                  <div class="container">
                  <div class="modal micromodal-slide" id="modal-1" aria-hidden="true">
                  <div class="modal__overlay" tabindex="-1" data-micromodal-close>
                    <div class="modal__container" role="dialog" aria-modal="true" aria-pledby="modal-1-title">
                      <header class="modal__header">
                        <h2 class="modal__title" id="modal-1-title">
                          Micromodal
                        </h2>
                        <button class="modal__close" aria-p="Close modal" data-micromodal-close></button>
                      </header>
                      ...
                      <footer class="modal__footer">
                        ...
                        <button class="modal__btn" data-micromodal-close aria-p="Close this dialog window">Close</button>
                      </footer>
                    </div>
                  </div>
                </div>
                ...
                <td>{{ $c->amount}}</td>    
                <td>
                <a href="{{ route('admin.formfours.show', $c->id)}}" class="btn btn-success fa fa-eye"></a>
                <a href="{{ route('admin.formfourfees.edit', $c->id)}}" class="btn btn-primary fa fa-edit" ></a>
                <form id="delete_from_{{$c->id}}" method="POST" action="{{ route('admin.formfourfees.destroy', $c->id) }}">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                ...
                <div class="form-group">
                <p for="name" class="col-sm-2">title</p>
                <div class="col-sm-12">
