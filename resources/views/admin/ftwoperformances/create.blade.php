...
<div class="col-md-1"> </div>
   <div class="col-md-10">    <div class="">
              ...
              <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.ftwoperformances.store')}}">
           <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="row">
                  ...
                  <select name="id" class="select2_single form-control" style="width: 100%" tabindex="-1" >
                                        ...
                                        <?php
                                        $result= mysqli_query($con,"select * from formtwos") or die (mysqli_error());
