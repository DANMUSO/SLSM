       ...
       <form enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.formones.update', $formone->id)}}">
           ...
           {{ method_field('PATCH')}}
                ...
                <div class="row">
                 ...
                 <div class="col-md-3">
                 <p for="">Chemistry</p>
                 <input name="chem" type="checkbox"  checked value="{{$formone->chem}}" class="form-control">
                 </div>
                 <div class="col-md-3">
                ...
                <div class="row">
                 ...
                 <div class="col-md-2">
                 <p for="">2 Sweaters</p>
                 <input type="checkbox" name="sweater" checked value="{{$formone->sweater}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Pair of Shoes</p>
                 <input type="checkbox" name="shoes" checked value="{{$formone->shoes}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Pair of Socks</p>
                 <input type="checkbox" name="sock" checked value="{{$formone->sock}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Shirts</p>
                 <input type="checkbox" name="shirt" checked value="{{$formone->shirt}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 T-Shirt</p>
                 <input type="checkbox" name="t_shirt" checked value="{{$formone->t_shirt}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Jackets</p>
                 <input type="checkbox" name="jacket" checked value="{{$formone->jacket}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Sport Uniforms</p>
                 <input type="checkbox" name="sport" checked value="{{$formone->sport}}" class="form-control">
                 </div>
                 <div class="col-md-2">
                 <p for="">2 Scout Uniforms</p>
                 <input type="checkbox" name="scout" checked value="{{$formone->scout}}" class="form-control">
                 </div>
                </div>
                </div>
                <hr>
                ...
                <div class="row">
                 ...
                 <input type="checkbox" name="east"  checked value="{{$formone->east}}" class="form-control">
                 </div>
                 <div class="col-md-3">
                 <p for="">Dormitory West</p>
                 <input type="checkbox" name="west"  checked value="{{$formone->west}}" class="form-control">
                 </div>
                 <div class="col-md-3">
                 <p for="">Dormitory South</p>
                 <input type="checkbox" name="south"  checked value="{{$formone->south}}" class="form-control">
                 </div>
                 <div class="col-md-3">
                 <p for="">Dormitory North</p>
                 <input type="checkbox" name="north"  checked value="{{$formone->north}}" class="form-control">
                 </div>
                </div></div>
                <hr>
