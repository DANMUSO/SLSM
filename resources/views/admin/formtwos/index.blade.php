...
@section('content')
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0 text-dark">Form Two Students</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <h2  style="color:white">Form Two Students
           </h2>
              </div>
              </span>
...
?> 
    ...
    <div class="col-md-2"><a href="{{ route('admin.formtwos.create')}}" class="btn btn-primary">Add Student</a></div></div>
    <div class="container">
...
<table id="example" class="display nowrap">
    ...
    <tbody id="myTable">
      ...
      <a href="{{ route('admin.formtwos.edit', $c->id)}}" class="btn btn-primary fa fa-edit" ></a>
      <form id="delete_from_{{$c->id}}" method="POST" action="{{ route('admin.formtwos.destroy', $c->id) }}">
      {{ csrf_field() }}
      {{ method_field('DELETE') }}
