...
@section('content')
 ...
 <div class="content-header">
  ...
  <div class="card card-primary">
       ...
       <form role="form" enctype="multipart/form-data" method="POST" action="{{ route('admin.feesettings.update',$feesetting->id)}}">
           ...
           {{ method_field('PATCH')}}
                ...
                <div class="row">
                  ...
                  <p for="">Fees Category</p>
                    ...
                    <option>{{ $feesetting -> category}}</option>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                  <p for="">Amount</p>
                    <input type="text" name="amount" value="{{ $feesetting -> amount}}" required class="form-control"  placeholder="Amount">
                    </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <p for="">Deadline</p>
                    <input type="date" name="deadline" value="{{ $feesetting -> deadline}}" required class="form-control"  placeholder="Driver">
                    </div>
