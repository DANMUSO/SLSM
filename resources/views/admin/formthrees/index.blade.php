...
@section('content')
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0 text-dark">Form Three Students</h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="info-box mb-3">
           ...
           <h6 style="color:white">Form Three Students
           </h6>
              </div>
              </span>
...
?> 
    ...
    <div class="col-md-2"><a href="{{ route('admin.formthrees.create')}}" class="btn btn-primary">Add Student</a></div></div>
    <div class="container">
...
<table id="example" class="display nowrap">
    ...
    <tbody id="myTable">
      ...
      <a href="{{ route('admin.formthrees.edit', $c->id)}}" class="btn btn-primary fa fa-edit" ></a>
      <form id="delete_from_{{$c->id}}" method="POST" action="{{ route('admin.formthrees.destroy', $c->id) }}">
      {{ csrf_field() }}
      {{ method_field('DELETE') }}
