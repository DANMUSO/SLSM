        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('admin/staffattendances')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('admin.schoolevents.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>School Events</p>
                </a>
              </li>
...
<script src="{{ asset('code/build/js/intlTelInput.js')}}"></script>
<script src="{{ asset('code/build/js/intlTelInput-jquery.min.js')}}"></script>
<script src="{{ asset('code/build/js/intlTelInput-jquery.js')}}"></script>
<script src="{{ asset('code/build/js/intlTelInput.min.js')}}"></script>
<script src="{{ asset('code/build/js/data.min.js')}}"></script>
<script src="{{ asset('code/build/js/data.js')}}"></script>
  ...
  <script>
    ...
    window.intlTelInput(input, {
      ...
      utilsScript: "{{ asset('code/build/js/utils.js')}}",
    });
  </script>
